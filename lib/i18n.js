...
export const CATEGORIES = [
  {
    ...
    items: [
      { id:"s1", zh:"豬肉腸",      en:"Pork Sausage",        unit:"lb", price:13.50 },
      { id:"s3", zh:"鴨肝腸",      en:"Duck Liver Sausage",  unit:"lb", price:14.50 },
    ],
  },
  {
    id: "pork", zh: "豬肉", en: "Pork",
    items: [
      { id:"p1", zh:"腊肉",        en:"Lap Yuk (Pork Belly)",          unit:"lb", price:14.50 },
      { id:"p2", zh:"只瘦腊肉",    en:"Lean Cured Pork",     unit:"lb", price:18.00 },
    ],
  },
  {
    ...
    items: [
      ...
      { id:"d05", zh:"腊鴨",       en:"Whole Cured Duck",    unit:"ea", price:42.00 },
